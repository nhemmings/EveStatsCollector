...
{
    internal static void LogKillsReport(ILogger logger, KillsReport report, Func<int, string?> resolveName)
    {
    ...
    internal static void LogJumpsReport(ILogger logger, JumpsReport report, Func<int, string?> resolveName)
    {
